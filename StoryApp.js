...
//---------------------------------------INPUT---------------------------------------
                            //PERATURAN PERMAINAN !!
    var input_1 = "A"; //A   // 1. SELALULAH ISI input_1 DENGAN A UNTUK MEMULAI PERMAINAN
...
//---------------------------------------INTERLOG---------------------------------------
    ...
    var interlog_1B = "[B] Ayah akan berhenti bekerja dan menjadi pedangdut Meikarta !";
    ...
    var interlog_2B = "[B] Hans dan Gretel berlatih untuk menjadi Meikarta Next Top Dangdut Idol !";
...
//---------------------------------------ENDING---------------------------------------
    ...
    var ending_2 = ["Ayah beralih profesi menjadi Pedangdut Profesional Meikarta.",
    ...
    var ending_3 = ["Hans dan Gretel berlatih keras untuk mengikuti ajang Meikarta Next Top Dangdut Idol.",
                    ...
                    "Mereka pun akhirnya dibuang oleh Ibu tiri mereka di Meikarta dan akhirnya mati kelaparan.",   
                    "THE END - TRY AND TRY AGAIN FELLAS $$."]
...
// var currentpageInterlogElement = pageInterlogElement[0];
// var currentpageInterlogElementContent = currentpageInterlogElement.innerHTML;
// console.log('===', currentpageInterlogElementContent);

// currentpageInterlogElement = startGame();
// var newcurrentpageInterlogElementContent = currentpageInterlogElement;
// console.log('===', newcurrentpageInterlogElementContent);

// document.getElementsByClassName('interlog').onclick = startGame();

var pageInterlogElement = document.getElementsByClassName('interlog');
pageInterlogElement[0].innerHTML = startGame(); 
